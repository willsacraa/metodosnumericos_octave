function [dwdz] = funcmassa_GD(x,w) 

%% Caso de estudo - Grupo D - Bruna, Debora e William
%% Function para encontrar a composicao
...
for i = 1:length(MW)
  dwdz(i) = ((Aint * MW(i)/M)* rhocat * (1 - epb) * (v(i,1)*r(1) + v(i,2)*r(2)));%*(0.01) + dwdz(i);
endfor 
endfunction